...
def create_student(params):
    ...
    # 不存在就做他存在
        ...
        user = Users.objects.create(user_id=params['code'], code=params['code'], nick=params['nick'], sex=params['sex'],
                                    academy=academy, grade=params['grade'], class_id=class_id, contact=params['contact'],
        ...
        try:
            ...
            for i in range(1, sheet.nrows):
                ...
                params = {
                    ...
                    'grade': int(row[4]), 'class_id': int(row[5]), 'contact': int(row[6]),
